    ...
    <div className="card">
      <div className="container">
        ...
        <div className="card__price">
          <p className="card__price-discount">$799</p>
          <s className="card__price-fullPrice">$899</s>
        ...
        <div className="card__specification">
          <div className="card__specification-wrapper">
            ...
            <div className="card__specification-value">5.8” OLED</div>
          </div>
          <div className="card__specification-wrapper">
            <div className="card__specification-part">Capacity</div>
            <div className="card__specification-value">64 GB</div>
          </div>
          <div className="card__specification-wrapper">
            <div className="card__specification-part">RAM</div>
            <div className="card__specification-value">4 GB</div>
          </div>
        </div>
